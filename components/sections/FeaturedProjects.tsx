    ...
    <section id="projects" className="relative max-w-5xl mx-auto px-6 py-32">
        ...
        {featuredProjects.map((project, index) => (
          ...
          >
            <Link
              ...
              className="group block bg-gray-900/40 border border-gray-800 rounded-xl overflow-hidden hover:border-accent-500/60 transition-colors"
            >
              {project.thumbnail && (
              ...
              <div className="p-5">
                <h3 className="font-semibold text-white mb-1.5 group-hover:text-accent-400 transition-colors">
                  {project.title}
                </h3>
      ...
      {featuredProjects.length > 0 && (
        <div className="flex justify-center mt-14">
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 text-sm text-white border border-gray-700 hover:border-accent-500/60 rounded-full px-5 py-2.5 transition-colors"
          >
